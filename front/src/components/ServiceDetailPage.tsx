...
export function ServiceDetailPage({ onNavigate }: ServiceDetailPageProps) {
  ...
  const services = [
    { name: "Installation de Canalisations", price: "À partir de 15000 CFA" },
    { name: "Réparation de Fuites", price: "À partir de 10000 CFA" },
    { name: "Nettoyage de Drains", price: "À partir de 8000 CFA" },
    { name: "Réparation de Chauffe-eau", price: "À partir de 20000 CFA" },
    { name: "Service d'Urgence", price: "À partir de 25000 CFA" },
  ];
