...
exports.createStandardNotificationMessage = createStandardNotificationMessage;
/**
 * Reformule un message de notification selon le destinataire
 * Évite les formulations à la première personne pour les admins
 */
function formatNotificationMessage(baseMessage, recipient, context) {
 ...
 */
function createStandardNotificationMessage(action, entity, recipient, context) {
    const templates = {
    ...
    return template[action] || `Action ${action} effectuée sur ${entity}`;
}
//# sourceMappingURL=notificationFormatter.js.map