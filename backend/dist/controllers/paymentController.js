...
class PaymentController {
    ...
    static async getMyPayments(req, res) {
      ...
      `;
            const [paymentsResult, countResult] = await Promise.all([
                (0, database_1.query)(paymentsQuery, [user.id, parsedLimit, offset]),
                (0, database_1.query)(countQuery, [user.id])
            ]);
    ...
    static async getPaymentById(req, res) {
      ...
      `;
            const paymentResult = await (0, database_1.query)(paymentQuery, [id, user.id]);
    ...
    static async getAllPayments(req, res) {
      ...
      `;
            ...
            const [paymentsResult, countResult] = await Promise.all([
                (0, database_1.query)(paymentsQuery, [parsedLimit, offset]),
    ...
    static async updatePaymentStatus(req, res) {
        ...
        RETURNING id, status
      `;
            const updateResult = await (0, database_1.query)(updateQuery, [status, id]);
