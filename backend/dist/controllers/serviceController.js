...
class ServiceController {
    ...
    static async update(req, res) {
        try {
            ...
            const providerProfileForUpdate = await prisma_1.prisma.providerProfile.findUnique({
                where: { userId: user.id },
            });
    ...
    static async delete(req, res) {
        try {
            ...
            // Check ownership - need to get the provider profile for this user
            const providerProfileForDelete = await prisma_1.prisma.providerProfile.findUnique({
                where: { userId: user.id },
            });
