...
const testAvailability = async () => {
  console.log("🔧 Testing availability route fix...\n");

  // Register provider
  const providerEmail = `provider-avail-test-${Date.now()}@example.com`;
  ...
  // Test update availability (should work now)
  ...
  if (availabilityRes.status === 200) {
    console.log("✅ Availability route fixed!");
  } else {
