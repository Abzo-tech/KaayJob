...
-- Généré le: 2026-04-04T21:20:22.386Z
-- ===================================================================
...
VALUES ('7b9031c1-b4e6-44c9-b7bc-dd92fef0c94f', 'Plomberie', 'plomberie', 'Services de plomberie et réparation', '🔧', NULL, true, 0, NULL, '2026-04-04T21:15:19.751Z', '2026-04-04T21:20:22.502Z')
ON CONFLICT (id) DO UPDATE SET
  name = EXCLUDED.name,
  slug = EXCLUDED.slug,
...
INSERT INTO categories (id, name, slug, description, icon, image, is_active, display_order, parent_id, created_at, updated_at)
VALUES ('9e793ff6-58f3-4aef-b50c-6165f0b9af0a', 'Électricité', 'electricite', 'Installation et réparation électrique', '⚡', NULL, true, 0, NULL, '2026-04-04T21:15:19.764Z', '2026-04-04T21:20:22.502Z')
ON CONFLICT (id) DO UPDATE SET
  name = EXCLUDED.name,
  slug = EXCLUDED.slug,
  description = EXCLUDED.description,
...
INSERT INTO categories (id, name, slug, description, icon, image, is_active, display_order, parent_id, created_at, updated_at)
VALUES ('87004d01-a4ee-4916-9448-5dd79da1c8f7', 'Menuiserie', 'menuiserie', 'Travaux de bois et menuiserie', '🔨', NULL, true, 0, NULL, '2026-04-04T21:15:19.772Z', '2026-04-04T21:20:22.502Z')
ON CONFLICT (id) DO UPDATE SET
  name = EXCLUDED.name,
  slug = EXCLUDED.slug,
  description = EXCLUDED.description,
...
INSERT INTO categories (id, name, slug, description, icon, image, is_active, display_order, parent_id, created_at, updated_at)
VALUES ('601fd16a-1d7a-4259-88ed-76987bc4a317', 'Peinture', 'peinture', 'Peinture intérieure et extérieure', '🎨', NULL, true, 0, NULL, '2026-04-04T21:15:19.782Z', '2026-04-04T21:20:22.502Z')
ON CONFLICT (id) DO UPDATE SET
  name = EXCLUDED.name,
  slug = EXCLUDED.slug,
  description = EXCLUDED.description,
...
INSERT INTO categories (id, name, slug, description, icon, image, is_active, display_order, parent_id, created_at, updated_at)
VALUES ('6b91210a-fa39-45d0-bb53-627377c70bfe', 'Jardinage', 'jardinage', 'Entretien d''espaces verts', '🌿', NULL, true, 0, NULL, '2026-04-04T21:15:19.790Z', '2026-04-04T21:20:22.502Z')
ON CONFLICT (id) DO UPDATE SET
  name = EXCLUDED.name,
  slug = EXCLUDED.slug,
  description = EXCLUDED.description,
...
INSERT INTO categories (id, name, slug, description, icon, image, is_active, display_order, parent_id, created_at, updated_at)
VALUES ('b1a8a320-0ff5-4727-946c-053ac905e89a', 'Ménage', 'menage', 'Services de nettoyage', '🧽', NULL, true, 0, NULL, '2026-04-04T21:15:19.799Z', '2026-04-04T21:20:22.502Z')
ON CONFLICT (id) DO UPDATE SET
  name = EXCLUDED.name,
  slug = EXCLUDED.slug,
  description = EXCLUDED.description,
...
INSERT INTO categories (id, name, slug, description, icon, image, is_active, display_order, parent_id, created_at, updated_at)
VALUES ('27691c02-99c4-4bfa-8afd-bf4f9bfa2fd9', 'Réparation', 'reparation', 'Réparations diverses', '🔧', NULL, true, 0, NULL, '2026-04-04T21:15:19.804Z', '2026-04-04T21:20:22.502Z')
ON CONFLICT (id) DO UPDATE SET
  name = EXCLUDED.name,
  slug = EXCLUDED.slug,
  description = EXCLUDED.description,
...
INSERT INTO categories (id, name, slug, description, icon, image, is_active, display_order, parent_id, created_at, updated_at)
VALUES ('bf48b588-df3c-44a3-903b-73374f8df791', 'Transport', 'transport', 'Services de transport', '🚚', NULL, true, 0, NULL, '2026-04-04T21:15:19.811Z', '2026-04-04T21:20:22.502Z')
ON CONFLICT (id) DO UPDATE SET
  name = EXCLUDED.name,
  slug = EXCLUDED.slug,
  description = EXCLUDED.description,
...
INSERT INTO categories (id, name, slug, description, icon, image, is_active, display_order, parent_id, created_at, updated_at)
VALUES ('8dfb681a-dd38-486c-997b-dae233c3c003', 'Cuisine', 'cuisine', 'Chefs et cuisiniers pour vos besoins du quotidien et evenements.', '👨‍🍳', '/images/cuisine.png', true, 0, NULL, '2026-04-04T21:20:19.817Z', '2026-04-04T21:20:22.502Z')
ON CONFLICT (id) DO UPDATE SET
  name = EXCLUDED.name,
  slug = EXCLUDED.slug,
  description = EXCLUDED.description,
...
INSERT INTO categories (id, name, slug, description, icon, image, is_active, display_order, parent_id, created_at, updated_at)
VALUES ('29fde352-d009-40ea-8628-9eeb42b940a2', 'Mecanique', 'mecanique', 'Diagnostic, entretien et reparation de vehicules.', '🔧', '/images/mecanique.png', true, 0, NULL, '2026-04-04T21:20:19.825Z', '2026-04-04T21:20:22.502Z')
ON CONFLICT (id) DO UPDATE SET
  name = EXCLUDED.name,
  slug = EXCLUDED.slug,
  description = EXCLUDED.description,
...
INSERT INTO categories (id, name, slug, description, icon, image, is_active, display_order, parent_id, created_at, updated_at)
VALUES ('c77acdbf-c426-45b0-8e85-5e9f940587a9', 'Education', 'education', 'Cours particuliers et accompagnement scolaire de proximite.', '📚', '/images/education.png', true, 0, NULL, '2026-04-04T21:20:19.833Z', '2026-04-04T21:20:22.502Z')
ON CONFLICT (id) DO UPDATE SET
  name = EXCLUDED.name,
  slug = EXCLUDED.slug,
  description = EXCLUDED.description,
...
-- Fichier généré: kaayjob-export-2026-04-04T21-20-22-386Z.sql
-- ===================================================================
