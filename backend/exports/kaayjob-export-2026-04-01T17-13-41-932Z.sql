...
-- Généré le: 2026-04-01T17:13:41.932Z
-- ===================================================================
...
INSERT INTO users (id, email, password, first_name, last_name, phone, role, bio, specialization, address, zone, latitude, longitude, avatar, is_verified, is_active, created_at, updated_at)
VALUES ('e9cc02e7-9940-48c1-a093-a0d1d40bcdcf', 'marie.menage@email.com', '$2a$12$5DD7OxuggOjmxOs/HhAUpukEpjfHI6nDW9EhA72bwRf.QqskRUY2i', 'Marie', 'Diop', '+221771234568', 'PRESTATAIRE', '', '', '', '', null, null, NULL, true, true, '2026-03-09T01:15:53.411Z', '2026-03-26T01:34:15.737Z')
ON CONFLICT (id) DO UPDATE SET
  email = EXCLUDED.email,
  password = EXCLUDED.password,
  first_name = EXCLUDED.first_name,
...
VALUES ('58878179-52f2-4ae4-8c52-9bed630ac0ed', 'Mécanique', 'mecanique', 'Services de mécanique automobile', '🔧', '/images/mecanique.png', true, 13, NULL, '2026-03-09T01:15:52.330Z', '2026-04-01T17:13:42.086Z')
ON CONFLICT (id) DO UPDATE SET
  name = EXCLUDED.name,
  slug = EXCLUDED.slug,
...
INSERT INTO categories (id, name, slug, description, icon, image, is_active, display_order, parent_id, created_at, updated_at)
VALUES ('aa4d5968-bc5a-4b9a-9050-233b76463917', 'Cuisine', 'cuisine', 'Services de cuisine et préparation de repas', '🍳', '/images/cuisine.png', false, 14, NULL, '2026-03-09T01:15:52.337Z', '2026-04-01T17:13:42.086Z')
ON CONFLICT (id) DO UPDATE SET
  name = EXCLUDED.name,
  slug = EXCLUDED.slug,
  description = EXCLUDED.description,
...
INSERT INTO categories (id, name, slug, description, icon, image, is_active, display_order, parent_id, created_at, updated_at)
VALUES ('402fd7ee-fb0b-4a29-939b-b03a1dfe661c', 'Ménage', 'menage', 'Services de nettoyage domestique', '🧹', 'https://images.unsplash.com/photo-1581578731548-c64695cc6952?w=800', true, 1, NULL, '2026-03-09T01:15:52.275Z', '2026-04-01T17:13:42.086Z')
ON CONFLICT (id) DO UPDATE SET
  name = EXCLUDED.name,
  slug = EXCLUDED.slug,
  description = EXCLUDED.description,
...
INSERT INTO categories (id, name, slug, description, icon, image, is_active, display_order, parent_id, created_at, updated_at)
VALUES ('f1ea2a99-b2d3-4ef6-8461-15455deb8b91', 'Bricolage', 'bricolage', 'Travaux de réparation et petit bricolage', '🔧', 'https://images.unsplash.com/photo-1530124566582-a618bc2615dc?w=800', true, 3, NULL, '2026-03-09T01:15:52.282Z', '2026-04-01T17:13:42.086Z')
ON CONFLICT (id) DO UPDATE SET
  name = EXCLUDED.name,
  slug = EXCLUDED.slug,
  description = EXCLUDED.description,
...
INSERT INTO categories (id, name, slug, description, icon, image, is_active, display_order, parent_id, created_at, updated_at)
VALUES ('3cb82a11-dabe-4de8-badc-cf6c0a6c8cff', 'Électricité', 'electricite', 'Services électriques et installation', '💡', 'https://images.unsplash.com/photo-1621905252507-b35492cc74b4?w=800', true, 4, NULL, '2026-03-09T01:15:52.285Z', '2026-04-01T17:13:42.086Z')
ON CONFLICT (id) DO UPDATE SET
  name = EXCLUDED.name,
  slug = EXCLUDED.slug,
  description = EXCLUDED.description,
...
INSERT INTO categories (id, name, slug, description, icon, image, is_active, display_order, parent_id, created_at, updated_at)
VALUES ('8f2989ab-8bf7-4e33-b7b8-e03e6dbc13fb', 'Plomberie', 'plomberie', 'Réparation plomberie et installation', '🚿', '/images/plomberie.png', true, 5, NULL, '2026-03-09T01:15:52.288Z', '2026-04-01T17:13:42.086Z')
ON CONFLICT (id) DO UPDATE SET
  name = EXCLUDED.name,
  slug = EXCLUDED.slug,
  description = EXCLUDED.description,
...
INSERT INTO categories (id, name, slug, description, icon, image, is_active, display_order, parent_id, created_at, updated_at)
VALUES ('c946a875-85f7-42cb-9aaa-dbdfc2aeb1b6', 'Peinture', 'peinture', 'Travaux de peinture intérieure et extérieure', '🎨', 'https://images.unsplash.com/photo-1562259949-e8e7689d7828?w=800', true, 6, NULL, '2026-03-09T01:15:52.293Z', '2026-04-01T17:13:42.086Z')
ON CONFLICT (id) DO UPDATE SET
  name = EXCLUDED.name,
  slug = EXCLUDED.slug,
  description = EXCLUDED.description,
...
INSERT INTO categories (id, name, slug, description, icon, image, is_active, display_order, parent_id, created_at, updated_at)
VALUES ('bc6ef689-c261-45df-844c-c1b94c6a4731', 'Déménagement', 'demangement', 'Aide au déménagement et transport', '📦', '/images/Demenagement.png', true, 7, NULL, '2026-03-09T01:15:52.299Z', '2026-04-01T17:13:42.086Z')
ON CONFLICT (id) DO UPDATE SET
  name = EXCLUDED.name,
  slug = EXCLUDED.slug,
  description = EXCLUDED.description,
...
INSERT INTO categories (id, name, slug, description, icon, image, is_active, display_order, parent_id, created_at, updated_at)
VALUES ('a922d45d-8adc-40d2-90c1-8a3bfe721939', 'Réparation', 'reparation', 'Services de réparation et maintenance', '🔩', '/images/Reparation.png', true, 8, NULL, '2026-03-09T01:15:52.303Z', '2026-04-01T17:13:42.086Z')
ON CONFLICT (id) DO UPDATE SET
  name = EXCLUDED.name,
  slug = EXCLUDED.slug,
  description = EXCLUDED.description,
...
INSERT INTO categories (id, name, slug, description, icon, image, is_active, display_order, parent_id, created_at, updated_at)
VALUES ('f85d17de-f0a4-4eca-bffc-1901fca5c11b', 'Maçon', 'macon', 'Travaux de construction et maçonnerie', '🧱', '/images/maçon.png', true, 9, NULL, '2026-03-09T01:15:52.308Z', '2026-04-01T17:13:42.086Z')
ON CONFLICT (id) DO UPDATE SET
  name = EXCLUDED.name,
  slug = EXCLUDED.slug,
  description = EXCLUDED.description,
...
INSERT INTO categories (id, name, slug, description, icon, image, is_active, display_order, parent_id, created_at, updated_at)
VALUES ('289ccb62-a3d0-4532-8661-19487169f202', 'Menuisier bois', 'menuisier-bois', 'Travail du bois et fabrication de meubles', '🪵', '/images/menuiserie.png', true, 10, NULL, '2026-03-09T01:15:52.314Z', '2026-04-01T17:13:42.086Z')
ON CONFLICT (id) DO UPDATE SET
  name = EXCLUDED.name,
  slug = EXCLUDED.slug,
  description = EXCLUDED.description,
...
INSERT INTO categories (id, name, slug, description, icon, image, is_active, display_order, parent_id, created_at, updated_at)
VALUES ('47fea6ad-8a16-4827-bc93-f54f1c7644af', 'Menuisier métallique', 'menuisier-metal', 'Travail du métal et ferronnerie', '⚙️', '/images/metalique.png', true, 11, NULL, '2026-03-09T01:15:52.319Z', '2026-04-01T17:13:42.086Z')
ON CONFLICT (id) DO UPDATE SET
  name = EXCLUDED.name,
  slug = EXCLUDED.slug,
  description = EXCLUDED.description,
...
INSERT INTO categories (id, name, slug, description, icon, image, is_active, display_order, parent_id, created_at, updated_at)
VALUES ('b594b2c0-e0d7-4ab0-8c0f-7e73884fc56f', 'Éducation', 'education', 'Cours à domicile et soutien scolaire', '📚', '/images/education.png', true, 12, NULL, '2026-03-09T01:15:52.323Z', '2026-04-01T17:13:42.086Z')
ON CONFLICT (id) DO UPDATE SET
  name = EXCLUDED.name,
  slug = EXCLUDED.slug,
  description = EXCLUDED.description,
...
INSERT INTO bookings (id, client_id, provider_id, service_id, status, booking_date, duration, total_amount, notes, created_at, updated_at)
VALUES ('73aa6156-8600-4898-a322-438bf41819f5', 'd6f31905-bdf5-40ed-8d5e-8822d8e9c387', 'undefined', '1fab6bbe-d394-4fda-8cd5-e70094271c17', 'PENDING', '2026-03-27T00:00:00.000Z', 60, 10000, NULL, '2026-03-26T18:57:49.951Z', '2026-03-26T18:57:49.951Z')
ON CONFLICT (id) DO UPDATE SET
  status = EXCLUDED.status,
  booking_date = EXCLUDED.booking_date,
  duration = EXCLUDED.duration,
...
-- Fichier généré: kaayjob-export-2026-04-01T17-13-41-932Z.sql
-- ===================================================================
